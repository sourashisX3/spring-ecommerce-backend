...
import com.example.ecommerce_backend.modules.product.service.ReviewService;
...
public class ReviewController {
    ...
    public ResponseEntity<ApiResponse<com.example.ecommerce_backend.modules.product.dto.response.VoteResponse>> voteReview(
            @PathVariable String reviewUuid,
            @Valid @RequestBody com.example.ecommerce_backend.modules.product.dto.request.VoteRequest request,
            @AuthenticationPrincipal User user
    ) {
